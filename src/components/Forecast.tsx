...
const Forecast = ({ data }: Props) => {
  ...
  return (
    <div className="w-full md:max-w-[500px] py-4 md:py-4 md:px-10 lg:px-24 h-full  bg-white bg-opacity-20 backdrop-blur-ls rounded drop-shadow-lg">
      <div className="mx-auto w-[300px]">
        ...
        <section className="flex flex-wrap justify-between text-zinc-700">
          ...
          <Tile
            icon="visibility"
            title="Visibility"
            info={`${(today.visibilty / 1000).toFixed()} km`}
            description={getVisibilityValue(today.visibilty)}
          />
        </section>
      </div>
    </div>
